    ...
    connectedCallback() {
        this.innerHTML =`
            <section class="my-[50px] md:my-[100px] container lg:px-0">
                ...
                <div
                    class="mt-[60px] grid grid-cols-1 grid-rows-3 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-3 lg:grid-rows-1 gap-[35px]" x-data="{ services: [{title: 'Web Design', description: 'Content marketing is nothing but offering users value.', img:'/assets/blog3.jpg'},{title: 'Agriculture', description: 'We engage in agricultural activities.'}, {title: 'Driving School', description: 'We engage in agricultural activities.'},{title: 'Preparatory Class for Concours', description: 'We engage in agricultural activities.'},{title: 'Preparatory Class for Concours', description: 'We engage in agricultural activities.'},{title: 'Preparatory Class for Concours', description: 'We engage in agricultural activities.'}] }">


                    <template x-for="service in services">
                        <div class="border-[1px] border-solid border-[#c8c3c3] ">
                            <div class="w-full h-[250px]">
                                <img src="./assets/blog3.jpg" class="w-[inherit] h-[inherit]">
                            </div>
